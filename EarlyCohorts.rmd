...
The code in the following analyses uses the following data frames: pretest.rds, lesson.rds, and posttestAll.rds. The raw data can be downloaded from the "Raw Data" tab, and the process used to get the raw data into the pretest.rds, lesson.rds, and posttestAll.rds format can be found in the "Data Process" tab. 
